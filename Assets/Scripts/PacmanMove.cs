...
public class PacmanMove : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Vector2 = Vector2.MoveTowards(transform.position, dest, speed);

        //移动刚体到Vector2位置，注意此处是Rigidbody2D
        GetComponent<Rigidbody2D>().MovePosition(Vector2);
        float dis1 = ((Vector2)transform.position - dest).magnitude;
        ...
        //print("当前位置 ：" + (Vector2)transform.position + "目标位置 ：" + dest);
        //获取移动方向
    ...
    private bool Valid(Vector2 dir)
    {
        ...
        RaycastHit2D hit = Physics2D.Linecast(pos, pos + dir2);
